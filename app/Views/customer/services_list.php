...
<div class="container mt-4">
    <div class="pagetitle">
        ...
        <p>Silakan pilih layanan yang kamu inginkan, <?= session('name'); ?>!</p>
    </div>
            ...
            <?php foreach ($services as $s) : ?>
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-body">
                            <h5 class="card-title fw-bold text-dark mt-2"><?= $s['name']; ?></h5>
                            <p class="card-text text-muted"><?= $s['description']; ?></p>
                            <h6 class="text-primary fw-bold">Harga: Rp <?= number_format($s['price'], 0, ',', '.'); ?></h6>
                        </div>
